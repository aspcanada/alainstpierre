      ...
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          <Tool title="14” MacBook Pro, M1, 16GB RAM (2021)">
            ...
            a single time, even under the incredibly heavy loads I put it
            through with our various build scripts.
          </Tool>
          <Tool title="27” Apple Cinema Display">
            While it&apos;s an older model now, this display still delivers
            excellent color accuracy and a crisp, clear picture. The built-in
            USB hub and speakers make it a clean, minimalist setup that has
            served me well for years.
          </Tool>
          <Tool title="Apple Wireless Keyboard">
            I&apos;ve been using this keyboard for years and it&apos;s still
            going strong.
          </Tool>
        ...
        <ToolsSection title="Development tools">
          <Tool title="Cursor AI">
            I&apos;ve just started using Cursor AI and it&apos;s already a game
            changer. It&apos;s the fastest way I&apos;ve found to get from idea
            to code.
          </Tool>
          <Tool title="iTerm2">
        ...
        <ToolsSection title="Productivity">
          <Tool title="Trello">
            I&apos;ve been using Trello for years and it&apos;s still my go-to
          ...
          <Tool title="Calendly">
            Calendly is my preferred tool for scheduling meetings. It&apos;s a
            great way to protect my calendar and make sure I still have lots of
          ...
          <Tool title="Spotify">
            I use Spotify to listen to music while I work. It&apos;s a great way
            to stay focused and get into the zone.
          </Tool>
        </ToolsSection>
      </div>
    </SimpleLayout>
